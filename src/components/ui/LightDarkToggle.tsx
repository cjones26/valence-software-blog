...
export default function LightDarkToggle({
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`flex cursor-pointer items-center text-slate-700 transition-colors hover:text-blue-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 dark:text-slate-200 dark:hover:text-cyan-400 dark:focus-visible:outline-cyan-400 ${layoutClasses} ${className}`}
